        ...
        <header className="absolute inset-x-0 top-0 z-50 bg-purple-50 ">
          ...
          {mobileMenuOpen && (
            <>
              ...
              {/* Sidebar Panel */}
              <div className="fixed inset-y-0 right-0 z-50 w-full sm:max-w-sm bg-gray-900 p-6 lg:hidden">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    type="button"
                    onClick={() => setMobileMenuOpen(false)}
                    className="-m-2.5 rounded-md p-2.5 text-gray-200 cursor-pointer hover:bg-gray-800"
                  >
